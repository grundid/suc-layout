...
const stalls = [
    ...
    new Stall(9.077264166666556, 49.21202433333333, 2.6, 4.7, 65, "4A"),
    new Stall(9.077355539849266, 49.21189102492057, 2.6, 4.7, 65, "2B"),
    new Stall(9.077340413025313, 49.21191221650785, 2.6, 4.7, 65, "3B"),
    new Stall(9.077312654712893, 49.21195535982072, 2.6, 4.7, 65, "1A"),
    new Stall(9.077370666666667, 49.21186983333334, 2.6, 4.7, 65, "1B"),
    new Stall(9.077296364266928, 49.21197818153005, 2.6, 4.7, 65, "2A"),
    new Stall(9.077280073813723, 49.21200100323938, 2.6, 4.7, 65, "3A"),
